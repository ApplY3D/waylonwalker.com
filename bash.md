...
long_description: Bash is super powerful. Bash is super powerful. * * * * There are
  so many options inside of  There are so many options inside of  https://waylonwalker.com/refactor-in-cli/
  https://waylonwalker.com/refactor-in-cli/ I use these replace commands heavily
now: 2022-05-07 21:32:25.892449
path: pages/notes/bash.md
slug: bash
status: published
super_description: 'Bash is super powerful. Bash is super powerful. * * * * There
  are so many options inside of  There are so many options inside of  https://waylonwalker.com/refactor-in-cli/
  https://waylonwalker.com/refactor-in-cli/ I use these replace commands heavily when
  doing large refactorings. I use these replace commands heavily when doing large
  refactorings. I like this one when there is not a good cli into config files and
  I need to replace something like a true to false if the value is in the config and '
tags:
- bash
- linux
- python
