...
description: Python  Python  Python  Python  * * When recieving variables as a  When
  recieving variables as a  Never add  Never add  Generally I find  Generally I find  If
  y
long_description: Python  Python  Python  Python  * * When recieving variables as
  a  When recieving variables as a  Never add  Never add  Generally I find  Generally
  I find  If your  If your  Here  Here  Here the function signature makes it clear
  what  Here the functi
now: 2022-05-07 21:32:25.892857
path: pages/blog/python-args-kwargs.md
slug: python-args-kwargs
status: published
super_description: 'Python  Python  Python  Python  * * When recieving variables as
  a  When recieving variables as a  Never add  Never add  Generally I find  Generally
  I find  If your  If your  Here  Here  Here the function signature makes it clear
  what  Here the function signature makes it clear what  Inversely we can send a list
  of things as individual arguments by  Inversely we can send a list of things as
  individual arguments by  Just like  Just like  Here is a function accepting  Here
  is a function accepting  '
tags:
- python
