...
long_description: This morning I logged into my machine and was nearly out of space
  This morning I logged into my machine and was nearly out of space 64GB miniconda3
  64GB miniconda3 5GB conda cache 5GB conda cache 4GM pip cache 4GM pip cache 34GB
  docker 34GB docker Ph
now: 2022-05-07 21:32:25.894033
...
super_description: 'This morning I logged into my machine and was nearly out of space
  This morning I logged into my machine and was nearly out of space 64GB miniconda3
  64GB miniconda3 5GB conda cache 5GB conda cache 4GM pip cache 4GM pip cache 34GB
  docker 34GB docker Photo by  Photo by  These are the commands that I often use to
  reclaim space.  Its so easy to fill up small vm These are the commands that I often
  use to reclaim space.  Its so easy to fill up small vm This shows us where to start
