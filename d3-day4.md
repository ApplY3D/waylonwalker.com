...
long_description: For what we are creating in these posts d3 is way overkill and very
  verbose, but I need to start somewhere For what we are creating in these posts d3
  is way overkill and very verbose, but I need to start somewhere Today I will be
  learning about d3 sc
now: 2022-05-07 21:32:25.892510
...
super_description: 'For what we are creating in these posts d3 is way overkill and
  very verbose, but I need to start somewhere For what we are creating in these posts
  d3 is way overkill and very verbose, but I need to start somewhere Today I will
  be learning about d3 scales, and adding them to the bar chart that we created yesterday.  Follow
  along as I try to create something interesting. Today I will be learning about d3
  scales, and adding them to the bar chart that we created yesterday.  Follow along
  as I try to '
tags:
- webdev
