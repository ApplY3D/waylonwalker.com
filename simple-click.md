...
long_description: cli tools are super handy and easy to add to your python libraries
  ...
  things that a cli can do to your library. cli tools are super handy and easy to
  add to your python li
now: 2022-05-07 21:32:25.894519
...
super_description: "cli tools are super handy and easy to add to your python libraries
  to supercharge them. Even if your library is not a cli tool there are a number of
  things that a cli can do to your library. cli tools are super handy and easy to
  add to your python libraries to supercharge them. Even if your library is not a
  cli tool there are a number of things that a cli can do to your library. Things
  a cli can do to enhance your library. Things a cli can do to enhance your library.
  \U0001F19A print version \U0001F19A print vers"
tags:
- python
- cli
