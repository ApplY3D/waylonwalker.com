...
long_description: One thing we all dread is mundane work of getting started, and all
  the hoops it One thing we all dread is mundane work of getting started, and all
  the hoops it When I start a new post I need to cd into my blog directory, start
  neovim in a When I star
now: 2022-05-07 21:32:25.893498
...
super_description: 'One thing we all dread is mundane work of getting started, and
  all the hoops it One thing we all dread is mundane work of getting started, and
  all the hoops it When I start a new post I need to cd into my blog directory, start
  neovim in a When I start a new post I need to cd into my blog directory, start neovim
  in a frontmatter template frontmatter template Title Title slug slug tags tags date
  date cover cover description description create markdown file create markdown file
  open in neovim open '
tags:
- blog
- python
