...
cover_image: https://images.waylonwalker.com/edit-on-github.png
...
The slug that I am getting from gatsby is formatted as `/blog/this-post/`. Note the trailing slash and missing file extension, thats where the
