...
description: 'GitHub actions are an amazing tool that allows us to run code based
  on triggers GitHub actions are an amazing tool that allows us to run code based
  on triggers '
...
now: 2022-05-07 21:32:25.894007
...
super_description: GitHub actions are an amazing tool that allows us to run code based
  on triggers GitHub actions are an amazing tool that allows us to run code based
  on triggers I have been diving deep into Github actions for about a month now and
  they are wicked good I have been diving deep into Github actions for about a month
  now and they are wicked good some interaction to your repository  some interaction
  to your repository  The online editor for actions is pretty amazing.  When creating
  a new workflow it au
tags:
- actions
