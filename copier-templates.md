...
long_description: '%%include til/copier %%include til/copier %%include til/copier-template-variables
  %%include til/copier-template-variables %%include til/copier-answers %%include til/copier-answers'
now: 2022-05-07 21:32:25.894239
path: pages/blog/copier-templates.md
slug: copier-templates
status: draft
super_description: '%%include til/copier %%include til/copier %%include til/copier-template-variables
  %%include til/copier-template-variables %%include til/copier-answers %%include til/copier-answers'
tags:
- python
- linux
