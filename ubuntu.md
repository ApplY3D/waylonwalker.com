...
long_description: I ran this, but have no idea if it had any effect as the theme did
  I ran this, but have no idea if it had any effect as the theme did What I think
  actuagnome terminal showing scrollbar in tmuxlly worked was What I think actuagnome
  terminal showing sc
now: 2022-05-07 21:32:25.893827
path: pages/blog/ubuntu.md
slug: ubuntu
status: draft
super_description: I ran this, but have no idea if it had any effect as the theme
  did I ran this, but have no idea if it had any effect as the theme did What I think
  actuagnome terminal showing scrollbar in tmuxlly worked was What I think actuagnome
  terminal showing scrollbar in tmuxlly worked was One thing that I really missed
  quite early from windows was the emoji virtual One thing that I really missed quite
  early from windows was the emoji virtual I found an application called emote. that
