...
description: As I continue to build out  As I continue to build out  Running integration
  tests will not prevent bugs from happening completely, but it will allow me to quick
long_description: 'As I continue to build out  As I continue to build out  Running
  integration tests will not prevent bugs from happening completely, but it will allow
  me to quickly spot them and rollback. Running integration tests will not prevent
  bugs from happening '
now: 2022-05-07 21:32:25.893894
path: pages/blog/testproject-io-py-actions.md
slug: testproject-io-py-actions
status: published
super_description: As I continue to build out  As I continue to build out  Running
  integration tests will not prevent bugs from happening completely, but it will allow
  me to quickly spot them and rollback. Running integration tests will not prevent
  bugs from happening completely, but it will allow me to quickly spot them and rollback.
  The very first thing that comes to my mind is anything that is loaded or ran client-side.  Two
  things quickly came to mind here.  I run gatsby so most of my content is statically
  ren
tags:
- python
