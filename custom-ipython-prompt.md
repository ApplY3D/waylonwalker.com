...
description: I I If you already have an ipython config you can move on otherwise check
  out this If you already have an ipython config you can move on otherwise check out
  thi
long_description: I I If you already have an ipython config you can move on otherwise
  check out this If you already have an ipython config you can move on otherwise check
  out this https://waylonwalker.com/ipython-config/ https://waylonwalker.com/ipython-config/
  I want
now: 2022-05-07 21:32:25.894099
path: pages/blog/custom-ipython-prompt.md
slug: custom-ipython-prompt
status: published
super_description: I I If you already have an ipython config you can move on otherwise
  check out this If you already have an ipython config you can move on otherwise check
  out this https://waylonwalker.com/ipython-config/ https://waylonwalker.com/ipython-config/
  I want something similar to the starship prompt I am using in the I want something
  similar to the starship prompt I am using in the python version python version active
  environment active environment git branch git branch This is my zsh prompt I am
  using f
tags:
- python
