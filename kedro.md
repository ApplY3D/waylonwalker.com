...
long_description: 'I am tweeting out most of these snippets as I add them, you can
  find them all here  I am tweeting out most of these snippets as I add them, you
  can find them all here  Below are some quick snippets/notes for when using kedro
  to build data pipelines. '
now: 2022-05-07 21:32:25.892457
...
super_description: I am tweeting out most of these snippets as I add them, you can
  find them all here  I am tweeting out most of these snippets as I add them, you
  can find them all here  Below are some quick snippets/notes for when using kedro
  to build data pipelines. So far I am just compiling snippets. Eventually I will
  create several posts on kedro. These are mostly things that I use In my everyday
  with kedro. Some are a bit more essoteric. Some are helpful when writing production
  code, some are useful more use
tags:
- kedro
- python
