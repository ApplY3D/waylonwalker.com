...
description: When first learning to code its very common to hard code everything right
  into When first learning to code its very common to hard code everything right into
  Ha
long_description: 'When first learning to code its very common to hard code everything
  right into When first learning to code its very common to hard code everything right
  into Hard coding everything right into your code makes it really hard for Hard coding
  everything '
now: 2022-05-07 21:32:25.893937
...
super_description: When first learning to code its very common to hard code everything
  right into When first learning to code its very common to hard code everything right
  into Hard coding everything right into your code makes it really hard for Hard coding
  everything right into your code makes it really hard for The cms generally come
  with a rich content editor that feels more like The cms generally come with a rich
  content editor that feels more like Even when you are developing for a technical
  audience there is
tags:
- webdev
