...
long_description: Kedro is an unopinionated Data Engineering framework that comes
  with a somewhat Kedro is an unopinionated Data Engineering framework that comes
  with a somewhat https://youtu.be/Wf4rnFsaFFU https://youtu.be/Wf4rnFsaFFU https://waylonwalker.com/what-is
now: 2022-05-07 21:32:25.893061
path: pages/blog/what-is-kedro.md
slug: what-is-kedro
status: published
super_description: Kedro is an unopinionated Data Engineering framework that comes
  with a somewhat Kedro is an unopinionated Data Engineering framework that comes
  with a somewhat https://youtu.be/Wf4rnFsaFFU https://youtu.be/Wf4rnFsaFFU https://waylonwalker.com/what-is-kedro-1/
  https://waylonwalker.com/what-is-kedro-1/ This is an updated version of my original
  what-is-kedro article This is an updated version of my original what-is-kedro article
  If you are doing a series of operations to data with python, especiall
tags:
- kedro
- python
