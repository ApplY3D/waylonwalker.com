...
cover: ''
date: 2021-05-11
datetime: 2021-05-11 00:00:00+00:00
description: 'In 2021 I changed the way I navigate between tmux sessions big time.  Now
  ...
  I can '
long_description: 'In 2021 I changed the way I navigate between tmux sessions big
  time.  Now I can In 2021 I changed the way I navigate between tmux sessions big
  time.  Now I can Since making this post, I have made ~20 other posts in short form
  that all have a YouTube '
now: 2022-05-07 21:32:25.893821
path: pages/blog/tmux-nav-2021.md
slug: tmux-nav-2021
status: published
super_description: In 2021 I changed the way I navigate between tmux sessions big
  time.  Now I can In 2021 I changed the way I navigate between tmux sessions big
  time.  Now I can Since making this post, I have made ~20 other posts in short form
  that all have a YouTube video to go along with them you can find them all on my
  Since making this post, I have made ~20 other posts in short form that all have
  a YouTube video to go along with them you can find them all on my I took Chris I
  took Chris I am now keeping proje
tags:
- cli
- linux
- tmux
