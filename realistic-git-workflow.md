...
description: 'My git workflow based on real life.  Its  not always clean and simple.
  My git workflow based on real life.  Its  not always clean and simple. As complicated
  as '
long_description: My git workflow based on real life.  Its  not always clean and simple.
  My git workflow based on real life.  Its  not always clean and simple. As complicated
  as that seems it is pretty straight forward.  When you sit down to work the first
  thing you d
now: 2022-05-07 21:32:25.892668
...
super_description: 'My git workflow based on real life.  Its  not always clean and
  simple. My git workflow based on real life.  Its  not always clean and simple. As
  complicated as that seems it is pretty straight forward.  When you sit down to work
  the first thing you do is to  As complicated as that seems it is pretty straight
  forward.  When you sit down to work the first thing you do is to  Next create a
  new branch with a name that will remind you of what you are working on.  For your
  own sanity choose something '
tags:
- git
