...
long_description: Pluggy makes it so easy to allow users to modify the behavior of
  a framework Pluggy makes it so easy to allow users to modify the behavior of a framework
  I I As long as the framework document the hooks that are available and what it As
  long as the fr
now: 2022-05-07 21:32:25.891672
...
super_description: Pluggy makes it so easy to allow users to modify the behavior of
  a framework Pluggy makes it so easy to allow users to modify the behavior of a framework
  I I As long as the framework document the hooks that are available and what it As
  long as the framework document the hooks that are available and what it Installing
  pluggy is just like most python applications, install python, make Installing pluggy
  is just like most python applications, install python, make At the time I started
  playing with p
tags:
- python
templateKey: til
