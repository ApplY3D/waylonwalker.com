...
description: Even though it is a static site there is no functionality lost.  The
  only thing that Even though it is a static site there is no functionality lost.  The
  only t
long_description: 'Even though it is a static site there is no functionality lost.  The
  only thing that Even though it is a static site there is no functionality lost.  The
  only thing that Even though it Even though it Kedro viz is a fantastic kedro plugin
  that allows '
now: 2022-05-07 21:32:25.892986
...
super_description: Even though it is a static site there is no functionality lost.  The
  only thing that Even though it is a static site there is no functionality lost.  The
  only thing that Even though it Even though it Kedro viz is a fantastic kedro plugin
  that allows you to visualize your data pipeline.  Kedro allows you to quickly build
  production-ready pipelines where you just configure a catalog, then toss python
  functions into a big pile.  Kedro figures out the order everything needs ran in
  for you, allows yo
tags:
- kedro
- python
