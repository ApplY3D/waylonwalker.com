...
description: 'I I https://youtu.be/xo4HrFoKF4c https://youtu.be/xo4HrFoKF4c The video
  ...
  my  You '
long_description: I I https://youtu.be/xo4HrFoKF4c https://youtu.be/xo4HrFoKF4c The
  video for this one is part of a The video for this one is part of a I have my  I
  have my  You will need the following plugins.  I use plug, if you don You will need
  the following plugi
now: 2022-05-07 21:32:25.894151
path: pages/blog/setup-yamlls.md
slug: setup-yamlls
status: published
super_description: 'I I https://youtu.be/xo4HrFoKF4c https://youtu.be/xo4HrFoKF4c
  The video for this one is part of a The video for this one is part of a I have my  I
  have my  You will need the following plugins.  I use plug, if you don You will need
  the following plugins.  I use plug, if you don Make sure that you have nvim Make
  sure that you have nvim Again if you don Again if you don Next up is the heart of
  this post, the lsp-config.lua.  This one is pretty Next up is the heart of this
  post, the lsp-config.lua. '
tags:
- linux
- vim
- neovim
