...
long_description: Web browsers are a black hole of productivity.  I try to use them
  as little as Web browsers are a black hole of productivity.  I try to use them as
  little as I am going to give a terminal rss reader a try for a bit and see how that
  goes I am going to
now: 2022-05-07 21:32:25.894083
...
super_description: Web browsers are a black hole of productivity.  I try to use them
  as little as Web browsers are a black hole of productivity.  I try to use them as
  little as I am going to give a terminal rss reader a try for a bit and see how that
  goes I am going to give a terminal rss reader a try for a bit and see how that goes
  I installed with the reccomended snap for Ubuntu. I installed with the reccomended
  snap for Ubuntu. Running help for newsboat directed me towards their config files
  at the bottom. Runn
tags:
- bash
- cli
