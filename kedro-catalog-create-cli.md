...
long_description: "I use  I use  https://youtu.be/ https://youtu.be/ https://waylonwalker.com/what-is-kedro/
  https://waylonwalker.com/what-is-kedro/ \U0001F446 Unsure what kedro is?  Check
  out this post. \U0001F446 Unsure what kedro is?  Check out this post. The command
  to ensure there "
now: 2022-05-07 21:32:25.893943
path: pages/blog/kedro-catalog-create-cli.md
slug: kedro-catalog-create-cli
status: published
super_description: "I use  I use  https://youtu.be/ https://youtu.be/ https://waylonwalker.com/what-is-kedro/
  https://waylonwalker.com/what-is-kedro/ \U0001F446 Unsure what kedro is?  Check
  out this post. \U0001F446 Unsure what kedro is?  Check out this post. The command
  to ensure there are catalog entries for every dataset in the passed The command
  to ensure there are catalog entries for every dataset in the passed Create Create
  Fills in new dataset entries with the default dataset Fills in new dataset entries
