...
cover: ''
date: 2020-03-02
datetime: 2020-03-02 00:00:00+00:00
description: "This is a quickstart to getting a new  This is a quickstart to getting
  a new  \U0001F9F9 Install  \U0001F9F9 Install  \U0001F6E2 Create the Example Pipeline
  \U0001F6E2 Create the Example Pipeline "
long_description: "This is a quickstart to getting a new  This is a quickstart to
  getting a new  \U0001F9F9 Install  \U0001F9F9 Install  \U0001F6E2 Create the Example
  Pipeline \U0001F6E2 Create the Example Pipeline \U0001F4A8 Run the example \U0001F4A8
  Run the example \U0001F4C9 Show the pipeline visualization \U0001F4C9 Show the pipeline "
now: 2022-05-07 21:32:25.893180
path: pages/blog/create-new-kedro-project.md
slug: create-new-kedro-project
status: published
super_description: "This is a quickstart to getting a new  This is a quickstart to
  getting a new  \U0001F9F9 Install  \U0001F9F9 Install  \U0001F6E2 Create the Example
  Pipeline \U0001F6E2 Create the Example Pipeline \U0001F4A8 Run the example \U0001F4A8
  Run the example \U0001F4C9 Show the pipeline visualization \U0001F4C9 Show the pipeline
  visualization I use conda to control my virtual environments and will create a new
  environment called  I use conda to control my virtual environments and will create
  a new environment called  Options Options I try to keep my base environment as clean"
tags:
- kedro
- python
